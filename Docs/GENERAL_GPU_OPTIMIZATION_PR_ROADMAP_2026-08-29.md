...
| 5 | Dirty-range state mirroring | Merge changed ranges and avoid full-buffer upload | upload bytes and CPU P95 improve at 0/1/10% motion; 100% motion remains an explicit one-command control | implemented; focused D3D12 evidence pending |
