...
| R004 | M0 | GPU correctness smoke | GPU mirror + cull + compact + indirect args | 1/255/256/257/4097 instances, 1–2 views | exact membership/counts/offsets/args, diagnostics | MUST | DONE | Current full D3D12 suite 543/543, zero skipped |
| R005 | M0.5 | Isolate rejected-pair contention | CulledTail vs VisibleOnly discard-key scatter | 1.05M instances, 4 views, 5/25/75/100% visible | native GPU mean/P50/P95, paired range, oracle | MUST | DONE | 95.20%/82.02%/34.78% mean reduction; 100% parity; 36,000/36,000 timestamps |
