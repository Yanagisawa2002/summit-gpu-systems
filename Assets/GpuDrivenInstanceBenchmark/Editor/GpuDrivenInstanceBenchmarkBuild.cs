...
public static class GpuDrivenInstanceBenchmarkBuild
{
    private const string TemporaryScenePath =
        "Assets/GpuDrivenInstanceBenchmark/Generated/" +
        "GpuDrivenInstanceBenchmark.generated.unity";
    ...
    public static void PerformBuild()
    {
        ...
        try
        {
            ...
            Scene scene = EditorSceneManager.NewScene(
                ...
                NewSceneMode.Single);
            scene.name = "GpuDrivenInstanceBenchmark";
            GameObject cameraHost =
                new GameObject("GPU Driven Instance Benchmark Camera");
            ...
            {
                "GPU driven-instance benchmark Player build",
            ...
            {
                throw new InvalidOperationException(
                    "GPU driven-instance Player build failed: " +
