...
public static class GpuSensorPipelineBenchmarkBuild
{
    private const string TemporaryScenePath =
        "Assets/GpuSensorPipelineBenchmark/Generated/" +
        "GpuSensorPipelineBenchmark.generated.unity";
    ...
    public static void PerformBuild()
    {
        ...
        try
        {
            ...
            Scene scene = EditorSceneManager.NewScene(
                ...
                NewSceneMode.Single);
            scene.name = "GpuSensorPipelineBenchmark";
            GameObject cameraHost =
                new GameObject("GPU Sensor Pipeline Benchmark Camera");
            ...
            {
                "GPU sensor-pipeline benchmark Player build",
            ...
            {
                throw new InvalidOperationException(
                    "GPU sensor-pipeline Player build failed: " +
