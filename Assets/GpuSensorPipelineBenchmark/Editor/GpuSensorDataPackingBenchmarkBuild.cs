...
public static class GpuSensorDataPackingBenchmarkBuild
{
    private const string TemporaryScenePath =
        "Assets/GpuSensorPipelineBenchmark/Generated/" +
        "GpuSensorDataPackingBenchmark.generated.unity";
    ...
    public static void PerformBuild()
    {
        ...
        if (!AssetDatabase.IsValidFolder(generatedDirectory))
        {
            AssetDatabase.CreateFolder(
                "Assets/GpuSensorPipelineBenchmark",
                "Generated");
        ...
        try
        {
            ...
            Scene scene = EditorSceneManager.NewScene(
                ...
                NewSceneMode.Single);
            scene.name = "GpuSensorDataPackingBenchmark";
            GameObject cameraHost =
                new GameObject("GPU Sensor Data Packing Benchmark Camera");
            ...
            {
                "GPU sensor data packing benchmark Player build",
            ...
            {
                throw new InvalidOperationException(
                    "GPU sensor data packing Player build failed: " +
