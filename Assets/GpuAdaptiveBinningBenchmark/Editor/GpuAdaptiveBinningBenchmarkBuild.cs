...
public static class GpuAdaptiveBinningBenchmarkBuild
{
    private const string TemporaryScenePath =
        "Assets/GpuAdaptiveBinningBenchmark/Generated/" +
        "GpuAdaptiveBinningBenchmark.generated.unity";
    ...
    public static void PerformBuild()
    {
        ...
        try
        {
            ...
            Scene scene = EditorSceneManager.NewScene(
                ...
                NewSceneMode.Single);
            scene.name = "GpuAdaptiveBinningBenchmark";
            GameObject cameraHost =
                new GameObject("GPU Adaptive Binning Benchmark Camera");
            ...
            {
                "GPU adaptive-binning benchmark Player build",
            ...
            {
                throw new InvalidOperationException(
                    "GPU adaptive-binning Player build failed: " +
